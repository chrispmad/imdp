align_mf_excel_records = function(dat){

  # Read in MF excel datasheets.
  dat15_mf = readxl::read_excel("2015 watercraft inspection data clean.xlsx", sheet = "Mussel Fouled",
                        skip = 1, col_types = "text")
  dat16_mf = readxl::read_excel("2016 watercraft inspection data clean.xlsx", sheet = "Mussel Fouled",
                        skip = 1, col_types = "text")
  dat17_mf = readxl::read_excel("2017 watercraft inspection data clean.xlsx", sheet = "Mussel Fouled",
                        skip = 1, col_types = "text")
  dat18_mf = readxl::read_excel("2018 watercraft inspection data clean.xlsx", sheet = "Mussel fouled",
                        skip = 1, col_types = "text")
  dat19_mf = readxl::read_xlsx("2019 watercraft inspection data clean.xlsx", sheet = 5,
                       skip = 1, col_types = "text")
